                  ...
                  >
                    ...
                    <div className="flex items-center gap-1.5">
                      <button
                        ...
                        className="flex items-center gap-0.5 px-2 py-1 rounded-lg text-[10px] font-medium bg-primary/10 text-primary hover:bg-primary/20 transition-colors"
                      >
                      ...
                      <button
                        ...
                        className="flex items-center gap-0.5 px-2 py-1 rounded-lg text-[10px] font-medium bg-destructive/10 text-destructive hover:bg-destructive/20 transition-colors"
                      >
